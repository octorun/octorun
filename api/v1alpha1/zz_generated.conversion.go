...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*v1alpha2.RunnerSetSpec)(nil), (*RunnerSetSpec)(nil), func(a, b interface{}, scope conversion.Scope) error {
	...
	if err := s.AddGeneratedConversionFunc((*v1alpha2.RunnerSetStatus)(nil), (*RunnerSetStatus)(nil), func(a, b interface{}, scope conversion.Scope) error {
...
// Convert_v1alpha2_RunnerSetSpec_To_v1alpha1_RunnerSetSpec is an autogenerated conversion function.
func Convert_v1alpha2_RunnerSetSpec_To_v1alpha1_RunnerSetSpec(in *v1alpha2.RunnerSetSpec, out *RunnerSetSpec, s conversion.Scope) error {
	return autoConvert_v1alpha2_RunnerSetSpec_To_v1alpha1_RunnerSetSpec(in, out, s)
}
...
// Convert_v1alpha2_RunnerSetStatus_To_v1alpha1_RunnerSetStatus is an autogenerated conversion function.
func Convert_v1alpha2_RunnerSetStatus_To_v1alpha1_RunnerSetStatus(in *v1alpha2.RunnerSetStatus, out *RunnerSetStatus, s conversion.Scope) error {
	return autoConvert_v1alpha2_RunnerSetStatus_To_v1alpha1_RunnerSetStatus(in, out, s)
}
